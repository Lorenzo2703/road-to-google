...
- **FNOMCeO Registry**: Spearheaded the cloud architecture and ensured the high availability of a national registry supporting nearly half a million users.
- **Infrastructure Automation**: Championed the transition to Dockerized microservices and orchestrated deployments on Kubernetes, significantly reducing toil and deployment errors.
- **Performance Optimization**: Published research on implementing architectures optimized for low-memory edge devices, showcasing deep understanding of hardware/software performance limitations.
- **ARIEN Project**: Developed and deployed highly available data ingestion pipelines to track complex financial flows and illicit activities in real-time.
